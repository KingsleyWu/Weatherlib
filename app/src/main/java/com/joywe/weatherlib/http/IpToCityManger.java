package com.joywe.weatherlib.http;

import android.text.TextUtils;
import android.util.Log;

import com.google.gson.Gson;
import com.joywe.weatherlib.model.ip.IP;
import com.joywe.weatherlib.model.ip.SoHuIP;
import com.joywe.weatherlib.model.ip.TaoBaoIP;
import com.joywe.weatherlib.model.ip.XinLangIP;
...
public class IpToCityManger {
     ...
     * @throws IOException IOException
     */
    private String getCityNameByXinLangUrl() throws IOException {
        try {
     ...
     * @return 成功返回城市名 失败返回null
     */
    private String getCityNameByTaoBaoUrl() {
        try {
     ...
     * @return 成功返回城市名 失败返回null
     */
    private String getCityNameBySoHuUrl() {
        try {
     ...
     * @return 成功返回城市名 失败返回null
     */
    private String getCityNameByIpUrl() {
        try {
    ...
    public static String getCityName(String address) {
        ...
        if (DataFormat.isEmpty(cityName)) {
            ...
            DebugUtil.d("cityName2 = " + cityName);
        }
        return cityName;
    }
     ...
     * @return 截取后的城市名字
     */
    private static String getCityNameStr(String address) {
     ...
     * @return 截取后的城市名字
     */
    private static String getCityNameByAddress(String address) {
